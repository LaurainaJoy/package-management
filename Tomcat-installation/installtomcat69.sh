...
sudo wget https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.670/bin/apache-tomcat-9.0.670.tar.gz
sudo tar -xvf apache-tomcat-9.0.670.tar.gz
sudo rm apache-tomcat-9.0.670.tar.gz
sudo mv apache-tomcat-9.0.670 tomcat9
